...
import type { KeyId, OverlayOptions, TUI } from "@mariozechner/pi-tui";
...
async function runFzfSelector(
  ...
  const result = await execShell(pi.exec.bind(pi), cmd.list, {
    timeout: 10000,
  });
...
function registerFzfShortcut(
  ...
  pi.registerShortcut(cmd.shortcut as KeyId, {
